...
final class UtilityPref4 {
    ...
    static func prefInitSoundingSitesLoc() {
        ...
        if value == "" {
            ...
            editor.putString("SND_KEY_X", "24.55")
            editor.putString("SND_KEY_Y", "81.75")
            editor.putString("SND_MFL_X", "25.75")
            editor.putString("SND_MFL_Y", "80.38")
            editor.putString("SND_YLW_X", "49.97")
            editor.putString("SND_YLW_Y", "119.38")
            editor.putString("SND_WPL_X", "51.47")
            editor.putString("SND_WPL_Y", "90.20")
            editor.putString("SND_YMO_X", "51.27")
            editor.putString("SND_YMO_Y", "80.65")
            editor.putString("SND_WMW_X", "46.0")
            editor.putString("SND_WMW_Y", "76.87")
            editor.putString("SND_76225_X", "28.70")
            editor.putString("SND_76225_Y", "106.07")
            editor.putString("SND_LIX_X", "30.337")
            editor.putString("SND_LIX_Y", "89.825")
            editor.putString("SND_IAD_X", "39.083667")
            editor.putString("SND_IAD_Y", "77.529224")
        }
    }
