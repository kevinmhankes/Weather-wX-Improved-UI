...
final class ObjectOglRadarBuffers: ObjectOglBuffers {

    var bgColor = 0
    var fileName = "nids"
    var rd = WXGLNexradLevelData()
    let colorRF: Float
    let colorGF: Float
    let colorBF: Float
    ...
    var colormap: ObjectColorPalette {return MyApplication.colorMap[Int(self.rd.productCode)]!}
