...
class WXMetalRender {
    ...
    private var lakeBuffers = ObjectMetalBuffers(GeographyType.lakes, 0.30)
    private var stiBuffers = ObjectMetalBuffers(PolygonType.STI)
    private var wbBuffers = ObjectMetalBuffers(PolygonType.WIND_BARB)
    ...
    private var hiBuffers = ObjectMetalBuffers(PolygonType.HI)
    private var tvsBuffers = ObjectMetalBuffers(PolygonType.TVS)
    ...
    private var swoBuffers = ObjectMetalBuffers()
    ...
    private var wbCircleBuffers = ObjectMetalBuffers(PolygonType.WIND_BARB_CIRCLE)
    private var spotterBuffers = ObjectMetalBuffers(PolygonType.SPOTTER)
    ...
    func constructPolygons() {
        ...
        case 153, 154, 56: self.totalBins = UtilityWXMetalPerf.genRadials(self.radarBuffers)
        case 0: break
