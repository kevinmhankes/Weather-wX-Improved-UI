...
final class UtilityColorPalette30 {

    static func generate() {
        let radarColorPaletteCode = 30
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64) // RF
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.redValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)  // green start
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(64)
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0) // RF
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        MyApplication.colorMap[radarColorPaletteCode]!.greenValues.put(0)
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(0)  // blue start
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(64)
        ...
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(123) // RF
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(64)
        MyApplication.colorMap[radarColorPaletteCode]!.blueValues.put(64)
