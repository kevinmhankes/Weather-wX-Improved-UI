...
struct PolygonType {
    ...
    static var WATCH_TORNADO = PolygonType(RadarGeometry.radarColorTorWatch,
                                           "WATCH_TORNADO",
    ...
    static var SPOTTER = PolygonType(RadarGeometry.radarColorSpotter,
                                     "SPOTTER",
                                     RadarPreferences.radarSpotters,
                                     RadarPreferences.radarSpotterSize)
    static var SPOTTER_LABELS = PolygonType(RadarGeometry.radarColorSpotter,
                                            "SPOTTER_LABELS",
    ...
    static var WIND_BARB = PolygonType(RadarGeometry.radarColorObsWindbarbs,
                                       "WIND_BARB",
                                       RadarPreferences.radarObsWindbarbs,
                                       RadarPreferences.radarAviationSize)
    static var WIND_BARB_CIRCLE = PolygonType(RadarGeometry.radarColorObsWindbarbs,
                                              "WIND_BARB_CIRCLE",
                                              RadarPreferences.radarObsWindbarbs,
                                              RadarPreferences.radarAviationSize)
    static var LOCDOT = PolygonType(RadarGeometry.radarColorLocdot,
                                    "LOCDOT",
                                    RadarPreferences.radarLocDot,
                                    RadarPreferences.radarLocdotSize)
    static var LOCDOT_CIRCLE = PolygonType(RadarGeometry.radarColorLocdot,
                                           "LOCDOT_CIRCLE",
                                           RadarPreferences.locdotFollowsGps,
                                           RadarPreferences.radarLocdotSize)
    static var STI = PolygonType(RadarGeometry.radarColorSti, "STI", RadarPreferences.radarSti)
    static var TVS = PolygonType(RadarGeometry.radarColorTor,
                                 "TVS",
                                 RadarPreferences.radarTvs,
                                 RadarPreferences.radarTvsSize)
    static var HI = PolygonType(RadarGeometry.radarColorHi,
                                "HI",
                                RadarPreferences.radarHi,
                                RadarPreferences.radarHiSize)
    static var OBS = PolygonType(RadarGeometry.radarColorObs,
                                 "OBS",
                                 RadarPreferences.radarObs)
    static var SWO = PolygonType(RadarGeometry.radarColorHi,
                                 "SWO",
    ...
    static func regen() {
        ...
        SPOTTER = PolygonType(RadarGeometry.radarColorSpotter,
                              "SPOTTER",
                              RadarPreferences.radarSpotters,
                              RadarPreferences.radarSpotterSize)
        SPOTTER_LABELS = PolygonType(RadarGeometry.radarColorSpotter,
                                     "SPOTTER_LABELS",
                                     RadarPreferences.radarSpottersLabel)
        WIND_BARB_GUSTS = PolygonType(Color.RED,
                                      "WIND_BARB_GUSTS",
                                      RadarPreferences.radarObsWindbarbs)
        WIND_BARB = PolygonType(RadarGeometry.radarColorObsWindbarbs,
                                "WIND_BARB",
                                RadarPreferences.radarObsWindbarbs,
                                RadarPreferences.radarAviationSize)
        WIND_BARB_CIRCLE = PolygonType(RadarGeometry.radarColorObsWindbarbs,
                                       "WIND_BARB_CIRCLE",
                                       RadarPreferences.radarObsWindbarbs,
                                       RadarPreferences.radarAviationSize)
        LOCDOT = PolygonType(RadarGeometry.radarColorLocdot,
                             "LOCDOT",
                             RadarPreferences.radarLocDot,
                             RadarPreferences.radarLocdotSize)
        LOCDOT_CIRCLE = PolygonType(RadarGeometry.radarColorLocdot,
                                    "LOCDOT_CIRCLE",
                                    RadarPreferences.locdotFollowsGps,
                                    RadarPreferences.radarLocdotSize)
