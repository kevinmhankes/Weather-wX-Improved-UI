...
class ObjectPolygonWarning {
    ...
    var typeName: String {return type.string.replaceAll("PolygonType.", "")}
    var urlToken: String {return longName[type]}
    var url: String {return baseUrl + urlToken}
    
    static let defaultColors: [PolygonType: Int] = [
        PolygonType.SMW: wXColor.colorsToInt(255, 165, 0),
        PolygonType.SQW: wXColor.colorsToInt(199, 21, 133),
        PolygonType.DSW: wXColor.colorsToInt(255, 228, 196),
        PolygonType.SPS: wXColor.colorsToInt(255, 228, 181),
    ...
    static let longName: [PolygonType: String] = [
    ...
    static var polygonDataByType: [PolygonType: ObjectPolygonWarning] = [:]
