...
final class UtilityHelp {
    ...
    static let helpStrings = [
        ...
        "spcswo": "Direct access to text and images for a specific SPC severe weather outlook. If Day 1 a submenu is available to access the state "
        ...
        "spcmcd": "Show active SPC Mesoscale discussions. If only one, text will be shown as well. If more than one, multiple images are shown and "
            + "you can tap on one to show the text. Once text is shown you can long press on the image to save one of the mentioned WFOs as a location.",
        "spcwat": "Show active SPC Watches. If only one, text will be shown as well. If more than one, multiple images are shown and you can tap "
            + "on one to show the text. Once text is shown you can long press on the image to save one of the mentioned WFOs as a location.",
        "spcmeso": "Access to SPC mesoanalysis data. Use a pullout nav drawer on the left to select parameters. Use the action bar menu "
            + "to select region. Common parameters are also shown in the action bar. Last region and parameter used are shown the next this activity is used.",
