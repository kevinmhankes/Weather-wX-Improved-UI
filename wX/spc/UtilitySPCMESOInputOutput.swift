...
final class UtilitySPCMESOInputOutput {
    ...
    static func getAnimation(_ sector: String, _ product: String, _ frameCntString: String) -> AnimationDrawable {
        var imgUrl = ""
        var bitmaps = [Bitmap]()
        ...
        let frameCnt = Int(frameCntString) ?? 0
        if timeList.count>frameCnt {
            stride(from: (frameCnt - 1), to: 0, by: -1).forEach {
